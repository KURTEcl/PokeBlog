...
export function pokemonTcgPlugin(): PluginDescriptor {
	return {
		id: "pokemon-tcg",
		version: VERSION,
		format: "native",
		entrypoint: "@poke-emdash/plugin-pokemon-tcg/native",
		adminEntry: "@poke-emdash/plugin-pokemon-tcg/admin",
		options: {},
		...
		adminWidgets: [
			{ id: "pokemon-shortcuts", title: "Pokémon TCG", size: "full" },
		],
		portableTextBlocks: [{
