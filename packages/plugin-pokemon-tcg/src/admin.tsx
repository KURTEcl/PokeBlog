...
const API = "/_emdash/api/plugins/pokemon-tcg";
...
function TcgShortcutsWidget() {
	...
	const links = [
		{ href: "/_emdash/admin/plugins/pokemon-tcg/decks", label: "Decklists", count: data?.decks.length, hint: "Importar y editar listas" },
		{ href: "/_emdash/admin/plugins/pokemon-tcg/archetypes", label: "Arquetipos", count: data?.archetypes.length, hint: "Pokémon del meta" },
		{ href: "/_emdash/admin/plugins/pokemon-tcg/results", label: "Resultados", count: data?.tournaments.length, hint: "Torneos y rondas" },
	];
...
export const widgets = { "pokemon-shortcuts": TcgShortcutsWidget };
